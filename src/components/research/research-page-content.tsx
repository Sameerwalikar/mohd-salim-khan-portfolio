              ...
              <div className="academic-card relative flex h-full flex-col justify-between rounded-xl p-6">
                <div>
                  ...
                  <h4 className="font-serif text-lg font-medium text-white group-hover:text-gold transition-colors leading-snug">
                    <span className="card-title-underline">{j.title}</span>
                  </h4>
                ...
                <div className="mt-auto pt-3 border-t border-gold/10 min-h-[44px] flex items-center justify-between gap-2">
                  {j.issn ? (
                    <span className="font-mono text-xs text-slate-400">{j.issn}</span>
                  ) : (
                    <span className="text-xs text-slate-500">Journal Article</span>
                  )}
              ...
              <div className="academic-card relative flex h-full flex-col justify-between rounded-xl p-6">
                <div>
                  ...
                  <h4 className="font-serif text-base font-semibold text-white transition-colors group-hover:text-gold leading-relaxed">
                    &ldquo;<span className="card-title-underline">{cp.title}</span>&rdquo;
                  </h4>
      ...
      workshops.forEach((w) => {
        if (matchesSearch(w.title) || matchesSearch(w.organizer)) {
          ...
          items.push({
            ...
            year,
            element: (
              <div className="academic-card relative flex h-full flex-col justify-between rounded-xl p-5">
                <div>
                  ...
                  <h4 className="font-serif text-sm font-semibold text-white leading-relaxed">
                    <span className="card-title-underline">{w.title}</span>
                  </h4>
                  <p className="mt-2 text-xs text-slate-400">
                    Organizer: <span className="text-slate-300">{w.organizer}</span>
                  </p>
                </div>
                <div className="mt-auto pt-3 border-t border-gold/10 min-h-[44px] flex items-center justify-between gap-2 text-[11px] text-slate-400">
